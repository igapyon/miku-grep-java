...
public final class HelpText {
    ...
    public static String helpText() {
        return "miku-grep - local-first structured grep CLI for AI agents and automation\n"
                ...
                + "    regex uses Java Pattern, line by line for content search.\n"
                + "    glob is for path-style matching in filepath / directory searches and listFiles mode.\n"
                + "\n"
                + "  query.text\n"
                ...
                + "    boolean. When true, search results include readfileHints for matched files.\n"
                + "\n"
                + "  output.maxMatches\n"
